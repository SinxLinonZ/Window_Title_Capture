...
namespace Live_Netease_Music_Title
{
    public partial class Form_Main_Window : Form
    {
        ...
        public static string G_Process_Name;
        ...
        public static IntPtr titleHook = new IntPtr();
        ...
        private int C_getProcessID()
        {
            ...
            var info = Process.GetProcessesByName(G_Process_Name);
            if (info.Length > 0)
            {
        ...
        private void C_refreshProcessList()
        {
            button_refreshProcessList.Enabled = false;
            ...
            foreach (var process in processes)
            {
                ...
                {
                    comboBox_ProcessList.Items.Add(process.ProcessName);
                }
            }
            richTextBox_Log.Text += "已更新进程列表\r\n";
            button_refreshProcessList.Enabled = true;
            comboBox_ProcessList.SelectedIndex = 0;
        }


        private void button_refreshProcessList_Click(object sender, EventArgs e)
        {
            C_refreshProcessList();
        }

        private void comboBox_ProcessList_SelectedIndexChanged(object sender, EventArgs e)
        {
            G_Process_Name = comboBox_ProcessList.SelectedItem.ToString();
        ...
        private void button_RefreshHandle_Click(object sender, EventArgs e)
        {
            C_getProcessID();
        }
        ...
        private void button_Switch_Click(object sender, EventArgs e)
        {
            ...
            if (running)
            {
                ...
                button_RefreshHandle.Enabled = true;
                button_refreshProcessList.Enabled = false;
                comboBox_ProcessList.Enabled = false;
                ...
                if (C_getProcessID() == 0)
                {
                    titleHook = SetWinEventHook(EVENT_OBJECT_NAMECHANGE, EVENT_OBJECT_NAMECHANGE, IntPtr.Zero,
        procDelegate, Convert.ToUInt32(G_process_ID), 0, WINEVENT_OUTOFCONTEXT);
            ...
            else
            {
                ...
                button_RefreshHandle.Enabled = false;
                button_refreshProcessList.Enabled = true;
                comboBox_ProcessList.Enabled = true;
            }
        }
